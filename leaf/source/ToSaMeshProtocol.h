...
#define RF_MESH_PTYPE_DISCOVER_REQUEST		0x0A	/* no hopack / no ack */
...
#define RF_MESH_PTYPE_DISCOVER_RESPONSE		0x8F	/* hopack / no ack */
#define RF_MESH_PTYPE_RESET					0x90	/* hopack / no ack */
...
#ifndef RF_MESH_HARDWARE_ATMEGA328
